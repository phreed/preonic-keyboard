...
image::../cache/keyboard_layers/freed-board-layer-0.svg[Layer 0 - Base Layer]

=== Layer 1 - Shifted Characters

Layer 1 provides access to shifted characters and symbols.

image::../cache/keyboard_layers/freed-board-layer-1.svg[Layer 1 - Shifted Characters]

=== Layer 2 - Advanced/Function Layer

Layer 2 features home-row modifiers and advanced key combinations for efficient typing.

image::../cache/keyboard_layers/freed-board-layer-2.svg[Layer 2 - Advanced/Function Layer]

=== Layer 3 - Symbols and Navigation

Layer 3 provides additional symbols and function keys F1-F5.

image::../cache/keyboard_layers/freed-board-layer-3.svg[Layer 3 - Symbols and Navigation]
...
image::../cache/keyboard_layers/freed-board-layer-4.svg[Layer 4 - Function Keys and Navigation]

=== Layer 5 - System Functions

Layer 5 contains system functions, boot controls, and audio/media keys.

image::../cache/keyboard_layers/freed-board-layer-5.svg[Layer 5 - System Functions]
...
[source,bash]
----
python scripts/gen-vis-board.py gen/freed-board.json src/layout-templates/LAYOUT_ortho_5x12-template.svg
----
